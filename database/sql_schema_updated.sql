...
CREATE TABLE public.notifications (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL,
  type text NOT NULL CHECK (type = ANY (ARRAY['project_invite'::text, 'task_assigned'::text, 'task_completed'::text, 'comment'::text, 'comment_reply'::text, 'follow'::text, 'join_request'::text, 'join_approved'::text, 'project_update'::text, 'issue_created'::text, 'issue_assigned'::text, 'issue_resolved'::text, 'discussion_mention'::text])),
  title text NOT NULL,
